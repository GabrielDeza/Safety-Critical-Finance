...
parser.add_argument('--train_length', default=1100, type=int, help='Length of training set')
parser.add_argument('--validation_length', default=1140, type=int, help='Length of validation set')
...
parser.add_argument('--max_iter', default=1, type=int, help='number of iterations on the adv dataset algorithm')
...
adv_greedy_gain_test, adv_test_invest, adv_testing_greedy_returns,adv_testing_greedy_PDT = greedy_gain(adv_testing_dates, adv_testing_pred_diff, adv_testing_target_diff,df_open,df_close)


#greedy gain_Kelly
kelly_greedy_gain_train,kelly_train_invest, kelly_training_greedy_returns,kelly_training_greedy_PDT,f_train = kelly_greedy_gain(training_dates, training_pred_diff,training_target_diff, df_open,df_close)
kelly_greedy_gain_test, kelly_test_invest, kelly_testing_greedy_returns,kelly_testing_greedy_PDT,f_test= kelly_greedy_gain(testing_dates, testing_pred_diff, testing_target_diff,df_open,df_close)
kelly_adv_greedy_gain_test, kelly_adv_test_invest, kelly_adv_testing_greedy_returns,kelly_adv_testing_greedy_PDT,f_adv = kelly_greedy_gain(adv_testing_dates, adv_testing_pred_diff, adv_testing_target_diff,df_open,df_close)
...
adv_threshold_gain_test,adv_testing_threshold_returns,adv_testing_threshold_PDT = threshold_gain(adv_testing_dates, adv_testing_pred_diff,adv_testing_target_diff,df_open,df_close)

#threshold gain kelly
kelly_threshold_gain_train, kelly_training_threshold_returns,kelly_training_threshold_PDT = kelly_threshold_gain(training_dates, training_pred_diff,training_target_diff,df_open,df_close)
kelly_threshold_gain_test,kelly_testing_threshold_returns,kelly_testing_threshold_PDT = kelly_threshold_gain(testing_dates, testing_pred_diff,testing_target_diff,df_open,df_close)
kelly_adv_threshold_gain_test,kelly_adv_testing_threshold_returns,kelly_adv_testing_threshold_PDT = kelly_threshold_gain(adv_testing_dates, adv_testing_pred_diff,adv_testing_target_diff,df_open,df_close)
