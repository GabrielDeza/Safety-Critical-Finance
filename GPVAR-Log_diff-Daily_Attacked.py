...
parser.add_argument('--train_length', default=400, type=int, help='Length of training set')
...
parser.add_argument('--max_iter', default=20, type=int, help='number of iterations on the adv dataset algorithm')
...
file_head = f"{company}_GPVAR_Daily_"
